...
public class EmployeeTest {
    ...
    public void testEmployeeSorting(){
        Employee e1 = new Employee(1, "SUMANTH", 500, 24, new Date(2016, 10, 1));
        Employee e2 = new Employee(2, "SRIDHAR", 600, 24, new Date(2017, 10, 1));
        Employee e3 = new Employee(3, "SAM", 700, 30, new Date(2013, 11, 3));
        Employee e4 = new Employee(4, "RAM", 800, 35, new Date(2012, 10, 1));
        Employee e5 = new Employee(5, "CAM", 900, 26, new Date(2010, 10, 1));
